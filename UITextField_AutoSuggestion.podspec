...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of UITextField_AutoSuggestion.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/UITextField_AutoSuggestion'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Kassymov Shyngys' => 'chika.kasymov@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/UITextField_AutoSuggestion.git', :tag => s.version.to_s }
